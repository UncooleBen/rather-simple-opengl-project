...

{
    ...
    char* texImg[26]={"data\\front.bmp","data\\back.bmp","data\\top.bmp",

            "data\\bottom.bmp","data\\right.bmp","data\\left.bmp","data\\shazi.bmp","data\\qiang.bmp",
			"data\\bizhi.bmp","data\\Door.bmp","data\\diban1.bmp","data\\airconditionfront.bmp",
			"data\\airconditionback.bmp","data\\dianshi.bmp","data\\zhuomian.bmp","data\\chenge.bmp",
			"data\\kirisaki.bmp","data\\xinyiji.bmp","data\\ft.bmp","data\\bk.bmp","data\\uup.bmp",
            "data\\dn.bmp","data\\rt.bmp","data\\lf.bmp","data\\fangding.bmp","data\\chuanghu.bmp"};
...
void reshape(int w, int h)
{
	...
	glLoadIdentity() ;
	gluPerspective(90,w/h,0.5,2000);  //透视效果
